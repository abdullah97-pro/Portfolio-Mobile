...
> Here is a Portfolio mobile showcasing all my Abilities, Skills and Achievements.it has two sections (the toolbar and the headline), it has mobile version and program used HTML and CSS also configured the (Linters) ability for error detecting and formatting the codes.
...
```sh
  cd my-folder
  git https://github.com/abdullah97-pro/Portfolio-Mobile
```
<!-- INSTALL -->
...
- **What new features should be expected in the next release of the project?**
  ...
  - In a short period **More Sections**. will be added
